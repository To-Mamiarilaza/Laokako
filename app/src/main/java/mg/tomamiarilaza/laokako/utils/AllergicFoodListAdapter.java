...
public class AllergicFoodListAdapter extends RecyclerView.Adapter<AllergicFoodListAdapter.ViewHolder> {

    private List<Ingredient> ingredients;
    private Context context;

    // constructor
    public AllergicFoodListAdapter(List<Ingredient> ingredients, Context context) {
