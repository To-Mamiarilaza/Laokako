...
public class Menu {
    ...
    public Menu(int id, String name, int duration, double rate, String recipe, boolean[] specificity, String frontPicture, String backPicture, IngredientQuantity[] ingredients) {
        this.id = id;
        this.name = name;
    ...
    public Menu(String name, int duration, int rate, String recipe, boolean[] specificity, String frontPicture, String backPicture, IngredientQuantity[] ingredients) {
        this.name = name;
        this.duration = duration;
        this.rate = rate;
        this.recipe = recipe;
    ...
    public IngredientQuantity[] getIngredients() {
        return ingredients;
    }

    public void setIngredients(IngredientQuantity[] ingredients) {
        this.ingredients = ingredients;
    }
    ...
    public static List<Menu> getAllMenu() {
        ...
        String frontPicture1 = "anana_totokena_front.png";
        String backPicture1 = "anana_totokena_back.png";
        IngredientQuantity[] ingredientQuantities1 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Anana"), 500, true),
                new IngredientQuantity(Ingredient.findByName("Totokena"), 1000, true),
                new IngredientQuantity(Ingredient.findByName("Voatabia"), 200, false),
                new IngredientQuantity(Ingredient.findByName("Tongolo"), 200, false)
        };
        ...
        String frontPicture2 = "atody_front.png";
        String backPicture2 = "atody_back.png";
        IngredientQuantity[] ingredientQuantities2 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Atody"), 800, true)
        };
        ...
        String frontPicture3 = "karoty_kisoa_front.png";
        String backPicture3 = "karoty_kisoa_back.png";
        IngredientQuantity[] ingredientQuantities3 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Karoty"), 500, true),
                new IngredientQuantity(Ingredient.findByName("Hena kisoa"), 1000, true),
                new IngredientQuantity(Ingredient.findByName("Percil"), 100, false),
                new IngredientQuantity(Ingredient.findByName("Tongolo"), 200, false),
                new IngredientQuantity(Ingredient.findByName("Voatabia"), 200, false)
        };
        ...
        String frontPicture4 = "kitoza_front.png";
        String backPicture4 = "kitoza_back.png";
        IngredientQuantity[] ingredientQuantities4 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Kitoza"), 1000, true)
        };
        ...
        String frontPicture5 = "ravimbomanga_front.png";
        String backPicture5 = "ravimbomanga_back.png";
        IngredientQuantity[] ingredientQuantities5 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Ravimbomanga"), 500, true),
                new IngredientQuantity(Ingredient.findByName("Voatabia"), 200, false),
                new IngredientQuantity(Ingredient.findByName("Tongolo"), 200, false)
        };
        ...
        String frontPicture6 = "anamamy_hena_omby_front.png";
        String backPicture6 = "anamamy_hena_omby_back.png";
        IngredientQuantity[] ingredientQuantities6 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Anamamy"), 500, true),
                new IngredientQuantity(Ingredient.findByName("Hena omby"), 200, true)
        };
        ...
        String frontPicture7 = "sambos_front.png";
        String backPicture7 = "sambos_back.png";
        IngredientQuantity[] ingredientQuantities7 = new IngredientQuantity[] {
                new IngredientQuantity(Ingredient.findByName("Sambos"), 600, true)
        };
